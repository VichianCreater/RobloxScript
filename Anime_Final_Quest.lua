...
-- Create Room Progress & Start Progress

-- Teleport To Portal Progress
-- 1 workspace.Teleports
-- 2 if ... workspace.Teleports["-25470Model"].Info.BillboardGui.Enabled == false
-- 3 Teleport

-- Open Ui Teleport
-- Click At >> game:GetService("Players").LocalPlayer.PlayerGui.HUD.Frames.Teleport.WORLDS.ScrollingFrame.Default.Button

-- Select Map Progress
-- Create Dropdown Select Map > 1.Summon Gate / 2.Summon Station - 1 / 3.Summon Station - 2 / 4.Statue's Cave >> Click At Selected in dropdown
-- Crete Dropdown Select Count Player > 1.1 2.2 3.3 4.4 >> Click At game:GetService("Players").LocalPlayer.PlayerGui.HUD.Frames.MapSelect.Info.No >> Until Value from game:GetService("Players").LocalPlayer.PlayerGui.HUD.Frames.MapSelect.Info.Count.TextLabel.Text to same in selected dropdown
-- Create Dropdown Select Difficulty > 1.DIFF: NORMAL / 2.DIFF: HARD / 3.DIFF: NIGHTMARE >> Click at game:GetService("Players").LocalPlayer.PlayerGui.HUD.Frames.MapSelect.Info.Difficulty >> Until Value from game:GetService("Players").LocalPlayer.PlayerGui.HUD.Frames.MapSelect.Info.Difficulty.TextLabel.Text to same in selected dropdown
-- Last Click At This Button > game:GetService("Players").LocalPlayer.PlayerGui.HUD.Frames.MapSelect.Info.Play

-- Example Click (From another script)
...
-- screen frame button textbutton
